...
export class LocationService {
    ...
    public async getAddressesWithinRadius(addressOfMapCenter: Address, addresses: Address[], radiusInKm: number): Promise<Address[]> {
        console.log('START: LocationService.getTermsOfUse');
        const center = new google.maps.LatLng(addressOfMapCenter.latitude, addressOfMapCenter.longitude);
    ...
    public async test(addressOfMapCenter: Address, addresses: Address[], radiusInKm: number): Promise<Address[]> {
        console.log('START: LocationService.getTermsOfUse');
